export const sections = [
  {
    ...
    body: [
      'We respect your privacy and are committed to protecting it through our compliance with this privacy policy (“Policy”). This Policy describes the types of information we may collect from you or that you may provide (“Personal Information”) on the aspirare.io website (“Website” or “Service”) and any of its related products and services (collectively, “Services”), and our practices for collecting, using, maintaining, protecting, and disclosing that Personal Information. It also describes the choices available to you regarding our use of your Personal Information and how you can access and update it.',
      'This Policy is a legally binding agreement between you (“User”, “you” or “your”) and Aspirare Inc (“Aspirare Inc”, “we”, “us” or “our”). If you are entering into this Policy on behalf of a business or other legal entity, you represent that you have the authority to bind such entity to this Policy, in which case the terms “User”, “you” or “your” shall refer to such entity. If you do not have such authority, or if you do not agree with the terms of this Policy, you must not accept this Policy and may not access and use the Website and Services. By accessing and using the Website and Services, you acknowledge that you have read, understood, and agree to be bound by the terms of this Policy. This Policy does not apply to the practices of companies that we do not own or control, or to individuals that we do not employ or manage.'
    ],
    toc: {
      title: 'Table of contents',
      links: [
        {
          url: '#collection-of-information',
          text: 'Collection of information'
        },
        { url: '#privacy-of-children', text: 'Privacy of children' },
        {
          url: '#use-and-processing-of-collected-information',
        ...
        { url: '#retention-of-information', text: 'Retention of information' },
        { url: '#do-not-track-signals', text: 'Do Not Track signals' },
        { url: '#links-to-other-resources', text: 'Links to other resources' },
        { url: '#information-security', text: 'Information security' },
        { url: '#data-breach', text: 'Data breach' },
        { url: '#changes-and-amendments', text: 'Changes and amendments' },
        {
          url: '#acceptance-of-this-policy',
          text: 'Acceptance of this policy'
        },
        { url: '#contacting-us', text: 'Contacting us' }
      ]
    }
  },
  {
  ...
  },
  {
    ...
    body: [
      ...
      { url: 'https://www.internetcookies.com/', text: 'internetcookies.com' }
    ]
  },
